...
void objektumok(World* world) {
	...
	load_model("models//porsche.obj", &world->object1.model);
	world->object1.texture = load_texture("textures//textura.png");
	init_object(&world->object1, 120, 170);


	load_model("models//porsche.obj", &world->object2.model);
	world->object2.texture = load_texture("textures//textura.png");
	init_object(&world->object2, -700, 170);
